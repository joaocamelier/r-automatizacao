...
# Relatório de Câmbio (BRL/USD)

## Introdução

Website feito em quarto com barra de navegação lateral. Link da documentação para maior estudo: **https://quarto.org/docs/reference/formats/html.html**
